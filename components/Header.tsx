...
const style = {
  ...
  accountAddress: `ml-2`,
  authButton: `bg-white font-bold text-red-500 px-2 py-1 items-center ml-1 rounded-lg hover:bg-red-500 duration-300 hover:text-white`,
};
          ...
          <>
            <div className={style.currentAccount}>
              <Image
                ...
                width={20}
              />
              <span className={style.accountAddress}>0x654645645645</span>
            </div>
            <button
